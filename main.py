...
from actions.agemoy2_1 import AppTablesAgeMoy
from actions.classmentpays2_2 import AppTablesclassementpays
...
class AppWindow(QMainWindow):
    ...
    def open_agemoy(self):
        if self.tablesAgeMoy is not None:
            self.tablesAgeMoy.close()
        self.tablesAgeMoy = AppTablesAgeMoy(self.data)
        self.tablesAgeMoy.show()
        self.changedValue.connect(self.tablesAgeMoy.refreshAllTablesAgeMoy)
    ...
    def open_classementpays(self):
        if self.tablesclassementpays is not None:
            self.tablesclassementpays.close()
        self.tablesclassementpays = AppTablesclassementpays(self.data)
        self.tablesclassementpays.show()
        self.changedValue.connect(self.tablesclassementpays.refreshAllclassementpays)
